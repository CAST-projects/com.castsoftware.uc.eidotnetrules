...
set CMD=dotnet.exe build %SRCDIR%\Sources\EICastQualityRules.csproj --framework %FRAMEWORK% --runtime %RUNTIME% /p:PublishReadyToRun=true /p:Platform=x64
@echo Executing %CMD%
call %CMD%
if errorlevel 1 goto endclean
...
:: ===================================================
set CMD=dotnet.exe build %SRCDIR%\UnitTests\UnitTests.csproj --framework %FRAMEWORK% --runtime %RUNTIME%  /p:PublishReadyToRun=true /p:Platform=x64
@echo Executing %CMD%
call %CMD%
if errorlevel 1 goto endclean
